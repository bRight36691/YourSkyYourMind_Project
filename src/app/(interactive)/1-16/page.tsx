...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <select
        className="select select-bordered mt-[6%] h-12 w-72 w-full max-w-xs justify-self-center rounded-xl text-center text-black disabled:border-none disabled:bg-white disabled:text-black"
        disabled
      >
