...
export default function Text({ state, setState }: prop) {
  if (state === 1) {
    return (
      <>
        <div className="absolute top-24 z-10 flex w-full flex-col items-center gap-6 text-center text-black">
          <div className="absolute h-[637px] w-[449px] rounded-full bg-[radial-gradient(closest-side,rgba(255,255,255,1)_0%,rgba(255,255,255,0.98)_36%,rgba(255,255,255,0.84)_60%,rgba(255,255,255,0.56)_77%,rgba(255,255,255,0)_100%)]" />
          <div className="absolute z-20 mt-40 flex flex-col gap-12">
            <div>
    ...
    return (
      <>
        <div className="absolute top-24 z-10 flex w-full flex-col items-center gap-6 text-center text-black">
          <div className="absolute h-[637px] w-[449px] rounded-full bg-[radial-gradient(closest-side,rgba(255,255,255,1)_0%,rgba(255,255,255,0.98)_36%,rgba(255,255,255,0.84)_60%,rgba(255,255,255,0.56)_77%,rgba(255,255,255,0)_100%)]" />
          <div className="absolute z-20 mt-40 flex flex-col gap-16">
            <div>
